...
HD_PWD='C:/Users/Saqib Rehman/Desktop/CALab2/CALab-Git-Saqib-Abbas/CALabProj/Task C/labProjectCA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelFPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopLevelFPGA.tcl
