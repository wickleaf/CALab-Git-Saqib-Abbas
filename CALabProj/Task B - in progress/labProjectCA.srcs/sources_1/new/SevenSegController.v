...
module SevenSegController(
    ...
    // --- Digit Selection ---
    // Only rightmost 2 digits active; leftmost 2 blanked
    // Display '00' when idle instead of turning off
    ...
    always @(*) begin
        if (display_blank) begin
            ...
            case (digit_sel)
                2'b00: begin        // AN0 (rightmost) = ones
                    an = 4'b1110;
                    current_digit = ones_val;
                end
                2'b01: begin        // AN1 = tens
                    an = 4'b1101;
                    current_digit = tens_val;
                end
                2'b10: begin        // AN2 = blanked
                    an = 4'b1111;
                    current_digit = 4'd0;
                end
                2'b11: begin        // AN3 = blanked
                    an = 4'b1111;
                    current_digit = 4'd0;
                end
                default: begin
